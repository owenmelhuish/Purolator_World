...
export const POIS = [
  {
    ...
    body: 'PUSH has four offices across North America, in Toronto, Ottawa, Los Angeles and Atlanta, with 75 functional experts and $300M in annual billings. We have been recognized by The Globe and Mail and Inc. 5000 as one of the top growing companies.\n\nOur philosophy is to be an extension of your team from day one. Leadership is involved from strategy through execution, ensuring every dollar goes further.',
  ...
  },
  {
    ...
    body: 'PUSH\'s ZeroWaste™ attitude means every dollar is strategically planned, making the dollars you have go further to fund results.\n\nWe can do this because we are independent, leverage AI, and underpin it with human brilliance. We believe in an iterative, intelligent process that allows for perpetual optimization, putting dollars in motion toward Purolator\'s business objectives.\n\nWe don\'t work in a linear fashion. We integrate strategy, media and creative together from the beginning to create a customized approach with you and your team, integrating technology at every stage. Everyone is welcome at the table.',
  ...
  },
  {
    ...
    body: 'We know that ideas can start anywhere. A creative spark becomes a channel plan, a media gap becomes a creative brief. PUSH is built cross-dimensional to handle the agility needed to win in today\'s markets, removing the traditional barriers that can exist in a linear model.\n\nOur technology brings media and creative together, from the first impression to the last. For Purolator, that means no silos to manage, no brief gets lost in translation, and one team is accountable for the whole journey.',
  ...
  },
  {
    ...
    body: 'Studio P is PUSH\'s creative arm, embedded inside the system: creative development, design and production under the same roof as the media it feeds. One master idea becomes an unlimited number of working variants. Any audience, any format, any language, versioned and refreshed as signals come in.\n\nWhat works is scaled. What tires is retired before it impacts the campaign.\n\nThe campaign never needs to run out of creative runway and can remain aligned at the pace the consumer engages with media. Message consistency by design, integrated with technology.',
